...
export default function Countries_History(){
    ...
    <div className="info_about">
       ...
       {data?.map(text=> 
          <h6 className='text-light p-2 bg-primary rounded-pill' onClick={()=>addData(text.description,text.history.ancientHistory,text.history.middleAgesAndIslamicEra,text.history.modernAndContemporaryEra)}>{text.name}</h6>
         )
         }
      </div>
     </>
